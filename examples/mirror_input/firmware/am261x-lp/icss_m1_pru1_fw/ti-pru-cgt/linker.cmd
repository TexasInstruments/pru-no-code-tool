...
MEMORY
{
	...
	PRU_IMEM	: org = 0x00000000 len = 0x00003000
      ...
      PAGE 1:
	/* Data RAMs */
	/* 8 KB PRU Data RAM 0; use only the first 4 KB for PRU1 and reserve
	 * the second 4 KB for RTU0 and Tx_PRU1 */
	PRU1_DMEM_0	: org = 0x00000000 len = 0x00001000
	...
	TX_PRU1_DMEM_0	: org = 0x00001800 len = 0x00000800
...
SECTIONS {
	...
	.udmem		>  PRU1_DMEM_0, PAGE 1
	.initdmem   >  PRU1_DMEM_0, PAGE 1
