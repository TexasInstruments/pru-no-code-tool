...
MEMORY
{
	...
	/* 8 KB PRU Data RAM 1; reserved completely for Slice1 cores - PRU0,
	 * RTU1 and Tx_PRU0; do not use for any Slice0 cores */
...
SECTIONS {
	...
	.udmem		>  PRU0_DMEM_0, PAGE 1
	.initdmem   >  PRU0_DMEM_0, PAGE 1
